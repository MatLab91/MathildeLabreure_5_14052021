...
btn_ours.addEventListener('click', function () {
...
btn_meubles.addEventListener('click', function () {
  displayProduct("furniture");
});

// Clique sur bouton cameras vintage pour afficher cette catégorie
const btn_cameras = document.getElementById('btn-cameras');
btn_cameras.addEventListener('click', function () {
